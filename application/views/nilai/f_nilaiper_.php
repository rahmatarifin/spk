<div class="col-12">
	<div class="card">
		...
		<div class="card-body">
			<form action="<?php echo base_url('index.php/nilai/per'); ?>" method="post">
			<?php foreach($alter as $alt) { ?>
				<div class="row form-group">
					...
					<div class="col-md-3">
						<input type="text" name="id_alternatif" class="form-control" value="<?php echo $alt->id_alternatif; ?>">
					</div>
					<div class="col-md-3">
						<input type="text" value="<?php echo $alt->nama; ?>" class="form-control">
					</div>
				</div>
			<?php } ?>
				<div class="row form-group">
